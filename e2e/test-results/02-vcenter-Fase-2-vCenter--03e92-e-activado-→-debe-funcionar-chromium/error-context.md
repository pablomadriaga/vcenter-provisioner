...
- Name: 02-vcenter.spec.ts >> Fase 2: vCenter Connection >> 2.3 - Test connection CON Insecure activado → debe funcionar
- Location: tests/02-vcenter.spec.ts:60:7
...
> 65  |     await insecureCheckbox.check()
  ...
  137 |       if (await altButton.isVisible().catch(() => false)) {
  138 |         await altButton.click()
  139 |       }
  140 |     }
  141 |     await page.waitForTimeout(1000)
  142 | 
  143 |     await helper.takeScreenshots('2.5-vcenter-form-empty')
  144 |     helper.printReport()
  145 |   })
  146 | })
  147 | 
```