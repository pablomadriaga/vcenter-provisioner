---
description: "Networking K8s: Contour HTTPProxy, API Gateway internals, Coroot queries"
category: deployment
priority: high
agent_role: debug, deploy
---
...
|----------|--------|------|
| api-gateway | 3000/TCP | ClusterIP, dinámico |
| auth-service | 3001/TCP | ClusterIP, dinámico |
| monitoring-service | 8082/TCP | ClusterIP, dinámico |
| provisioner-ui | 80/TCP | ClusterIP, dinámico |
| pgbouncer | 6432/TCP | ClusterIP, dinámico |
...
- API Key: `<API_KEY>` (ver shared-secrets)
