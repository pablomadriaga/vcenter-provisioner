...
$services = @(
    @{ Name = "VM Orchestrator"; Path = "projects\vcenter-provisioner\apps\vm-orchestrator"; TestCommand = "go test -v ./..."; CoverageCommand = "go test -coverprofile=coverage.out ./... ; go tool cover -func=coverage.out" },
    @{ Name = "Auth Service"; Path = "projects\vcenter-provisioner\apps\auth-service"; TestCommand = "npm test"; CoverageCommand = "npm run test:coverage" },
    @{ Name = "Typing Service"; Path = "projects\vcenter-provisioner\apps\typing-service"; TestCommand = "python -m pytest app/test_typing.py -v"; CoverageCommand = "python -m pytest app/test_typing.py -v --cov=app" },
    @{ Name = "vCenter Integration"; Path = "projects\vcenter-provisioner\apps\vcenter-integration"; TestCommand = "go test -v ./..."; CoverageCommand = "go test -coverprofile=coverage.out ./... ; go tool cover -func=coverage.out" },
    @{ Name = "Stats Service"; Path = "projects\vcenter-provisioner\apps\stats-service"; TestCommand = "python -m pytest app/test_stats.py -v"; CoverageCommand = "python -m pytest app/test_stats.py -v --cov=app" },
    @{ Name = "Monitoring Service"; Path = "projects\vcenter-provisioner\apps\monitoring-service"; TestCommand = "go test -v ./..."; CoverageCommand = "go test -coverprofile=coverage.out ./... ; go tool cover -func=coverage.out" }
)
